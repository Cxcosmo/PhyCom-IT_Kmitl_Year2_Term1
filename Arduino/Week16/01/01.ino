...
const char MQTT_CLIENT_ID[] = "Cxcosmo";  // CHANGE IT AS YOU DESIRE
const char MQTT_USERNAME[] = "";              // CHANGE IT IF REQUIRED, empty if not required
const char MQTT_PASSWORD[] = "";              // CHANGE IT IF REQUIRED, empty if not required

// The MQTT topics that Arduino should publish/subscribe
const char PUBLISH_TOPIC[] = "67070069";       // CHANGE IT AS YOU DESIRE
const char SUBSCRIBE_TOPIC[] = "67070066";  // CHANGE IT AS YOU DESIRE
...
void sendToMQTT() {
  ...
  // mqtt.publish(PUBLISH_TOPIC, "Gumairub");
  
  // Serial.println("Arduino UNO R4 - sent to MQTT:");
  // Serial.print("- topic: ");
  // Serial.println(PUBLISH_TOPIC);
  // Serial.print("- payload:");
  // Serial.println("Gumairub");
}
